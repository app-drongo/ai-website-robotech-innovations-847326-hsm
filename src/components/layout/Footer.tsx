...
const DEFAULT_FOOTER = {
  logoText: 'RoboTech',
  companyDescription:
    'Pioneering the future of robotics with cutting-edge AI and automation solutions. Join industry leaders who trust our advanced robotic systems to transform their operations.',
  ...
  newsletterDisclaimer:
    'Get the latest robotics insights and product updates. No spam, unsubscribe anytime.',
  ...
  // Product Links
  linkFeatures: 'Robot Models',
  linkFeaturesHref: '/robots',
  linkPricing: 'Pricing',
