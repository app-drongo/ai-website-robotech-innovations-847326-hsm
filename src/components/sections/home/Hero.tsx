...
const DEFAULT_HERO = {
  badge: 'New: Advanced Robotics Platform',
  title: 'Build the future with',
  titleHighlight: 'Intelligent Robotics',
  description:
    'Revolutionary robotics solutions powered by AI and machine learning. Perfect for manufacturing, logistics, and automation industries.',
  features: [
  ...
  imageAlt: 'Advanced robotic arm in action',
  statsLabel1: 'Precision',
  statsValue1: '99.9% Accuracy',
  statsLabel2: 'Efficiency',
  statsValue2: '300% Faster',
} as const;
